...
이 프로젝트는 한국투자증권 모의투자 환경을 기준으로 작성되었습니다.

실제 투자 환경에서 사용하려면 다음 사항을 반드시 추가로 검토해야 합니다.
...
현재 시스템은 모의투자 자동매매의 기본 구조를 구현한 버전입니다.

다만 다음 기능은 아직 고도화가 필요합니다.

* 미체결 주문 취소 기능
* 실시간 체결 통보 WebSocket 처리
* 다중 종목 자동매매
* 주문 가능 현금 확인
* 매매 내역 저장
* 수익률 통계 저장
